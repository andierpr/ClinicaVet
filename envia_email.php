...
define('SERVIDOR', 'andierprattes@hotmail.com');
// Para onde será enviado o contato
define('DESTINO', 'andier.prattes@gmail.com');
// Identifica o site que foi enviada a mensagem
define('SITE', 'ClinicaVet');
if (isset($_POST)):
    $nome    = (isset($_POST['nome']))? $_POST['nome']: '';
    $email   = (isset($_POST['email']))? $_POST['email']: '';
    $assunto = (isset($_POST['assunto']))? $_POST['assunto']: '';
    $msg     = (isset($_POST['texto']))? $_POST['texto']: '';
    ...
    if (empty($nome) || empty($email) || empty($assunto) || empty($msg)):
        ...
        $pdo = new PDO('mysql:host=localhost;dbname=clinicavet', 'root', 'admin', $opcoes);
